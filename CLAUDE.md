...
- **Current state: 766 tests, 100% coverage** across all 19 modules (2 156 statements)
...
**Pre-1.0 exception:** while the package is at `0.x`, breaking changes to the
report model or `assess()` behaviour may ship in a **minor** bump, provided
the CHANGELOG entry is explicitly labelled **Breaking:** and the GitHub
release includes a Migration section. Reserve `1.0.0` for the first
